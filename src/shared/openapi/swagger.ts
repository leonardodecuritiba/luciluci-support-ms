...
const swaggerOptions: swaggerJSDoc.Options = {
	definition: {
		...
		info: {
			...
			version: '1.0.0',
			description:
				'OpenAPI contract for the standard-ms template. Public authentication uses Bearer JWT via Identity MS, with validation enforced upstream by the API Gateway/BFF.',
		},
	},
	apis: isDev
		? [
