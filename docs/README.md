...
RF09–RF13 permanecem sem runtime. O contrato RF09 Support 0.11 está congelado
localmente, com DEC-SUP-01/08/09 resolvidas somente nesse recorte; a publicação
canônica remota permanece pendente. O checkpoint histórico e o report de
fechamento estão em `reports/`.

A documentação canônica de negócio fica em `../luciluci-docs/support/`; o
gitlink desta branch aponta à revisão 0.11 local (`a198b46`), ainda não publicada.
