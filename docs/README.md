...
RF09 está integrada; RF10 ainda não está em `main` e RF11–RF13 permanecem sem runtime. O contrato RF09 Support
...
Na branch `feat/support-rf10-create-message`, RF10 já está implementada e
provada localmente em PostgreSQL descartável, suíte HTTP/SQLite e smoke da
imagem; ainda não está integrada em `main`. RF11–RF13 permanecem sem runtime.
